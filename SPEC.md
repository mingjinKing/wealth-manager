...
> V1 聚焦版 —— 纯工具定位
> 版本：v2.2 | 更新：2026-04-02 | 变更：补充产品哲学（极简操作、静默守护、适时出现）、旺财人格定义
...
## 1.5 产品哲学：极简操作，静默守护，适时出现

> **使命**：帮助普通老百姓精打细算，花该花的，不花冤枉钱。
...
**产品人格：旺财**——知财的 AI 管家。旺财静默分析数据，在用户需要时给出洞察和建议，背后由规则引擎（精准计算）+ LLM（语义理解）驱动。
